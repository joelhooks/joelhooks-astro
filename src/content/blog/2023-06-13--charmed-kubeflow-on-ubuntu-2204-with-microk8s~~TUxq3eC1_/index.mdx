...
Miller Hooks has been guiding me througj some explorations in self-hosting the ops for training ML models and other GOI heavy workloads on my own infrastructure  

I'm excited about the future of machine learning, large language models but want to be an actove oarticipant and not a passive consumer of commercial APIs and various walled gardens.
