...
import BlurReveal from '../../../components/BlurReveal.astro';
import transformationImg from './transformation.jpg';
...
<BlurReveal src={transformationImg} alt="Before and after transformation" caption="Before and after" />
