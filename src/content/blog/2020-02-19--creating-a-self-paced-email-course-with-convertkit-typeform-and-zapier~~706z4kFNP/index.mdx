...
[ConvertKit](https://partners.convertkit.com/4xxwjvqn59fl) provides powerful automations that we can use to produce this course and make it flow smoothly. While powerful, CK automations can also be aggravating, prone to error, hard to test, and easy to fuck up in general lol. I'm going to give a quick review of how we managed this but I highly recommend [Brennan's course](https://createandsell.co/courses/mastering-convertkit?ref=joelhooks) as it goes into much more depth.
...
If you want to start your own email list, I love [ConvertKit](https://partners.convertkit.com/4xxwjvqn59fl) and the team they have built. Can't recommend them more highly.
