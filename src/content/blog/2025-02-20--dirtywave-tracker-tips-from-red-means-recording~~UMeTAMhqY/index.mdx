...
Okay, here's a quick markdown cheat sheet summarizing the main points from the video about the Dirtywave M8 Tracker. I'm red=recording, so I've focused on tips and tricks for workflow and some of the less obvious creative techniques:

# M8 Tracker: Quick Tips and Tricks
