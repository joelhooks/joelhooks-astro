...
One are that this has been modestly challenging for me is with [ConvertKit](https://joel.dev/convertkit) (and email marketing in general).
...
That's it! Now you've got a local copy of your emails that you can save or even version control, and a well-styled HTML email in [Convertkit](https://joel.dev/convertkit). 
