...
[Convertkit](https://partners.convertkit.com/4xxwjvqn59fl) automations provide a powerful mechanism for delivering [self-paced email courses](/self-paced-email-course) that can transition into an evergreen product pitch and promotion for your product.
...
This is where the **self-paced email course** comes into the equation. Using [Convertkit](https://partners.convertkit.com/4xxwjvqn59fl) automations, we can design a course that allows the subscriber to interact with the material and progress through the course as quickly as they want. Each email will provide a **call to action** that the subscriber can perform to trigger the next email.
...
![screenshot of the container automation from the convertkit user interface](https://joelhooks.com/images/convertkit-container-automation.png)
...
![screenshot of a convertkit automation of a self-paced email course](https://joelhooks.com/images/self-paced-email-course-in-convertkit.png)
...
![screenshot of a convertkit visual automation of the bridge sequence](https://joelhooks.com/images/convertkit-bridge-sequence-automation.png)
...
![screenshot of the email sequence for the warm bridge](https://joelhooks.com/images/converkit-bridge-sequence.png)
...
![screenshot of the sales pitch automation in convertkit](https://joelhooks.com/images/sales-pitch-automation-in-convertkit.png)
...
![screenshot of the convertkit email sequence for the pitch](https://joelhooks.com/images/sales-pitch-sequence-in-convertkit.png)
...
_I use affiliate links liberally in this post to [Brennan's Mastering Convertkit](https://createandsell.co/courses/mastering-convertkit?ref=joelhooks) and [Convertkit](https://partners.convertkit.com/4xxwjvqn59fl) itself. Feel free to Google them if you'd prefer I not get paid anything!_