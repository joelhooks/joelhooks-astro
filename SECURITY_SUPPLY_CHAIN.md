...
This repo treats dependency, workflow, and script changes as security-sensitive.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, `scripts/`, and deploy config.
...
If a compromised package install ran: assume local/user secrets are burned, revoke npm/GitHub/cloud tokens, rotate deploy secrets, compare build artifacts against source, and rebuild the machine instead of surgical cleanup theater.
